...
// A mechanism to set up anonnymous functions (without names). Once we have them set up, we can either give them names amd call , or
// we can even get them to do things directly
 

// Declaring and using lambdas function
